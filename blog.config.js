...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是孙锐，一个打工人,也是一个干饭人,欢迎来到我的博客🎉',
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/wang2.svg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
